...
#define IM_OFFSETOF(_TYPE,_MEMBER)  (intptr_t)(&(((_TYPE*)0)->_MEMBER))          // Offset of _MEMBER within _TYPE. Standardized as offsetof() in C++11
#else
...
enum ImGuiKey_
{
    ...
    ImGuiKey_D,                 // for games
    ImGuiKey_S,                 // for games
    ImGuiKey_V,                 // for text edit CTRL+V: paste
    ImGuiKey_W,                 // for games
