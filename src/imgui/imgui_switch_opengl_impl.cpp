#include "imgui_switch_opengl_impl.h"

#if defined(PLATFORM_NS)
...
static bool initEgl(NWindow* win)
{
    ...
    s_surface = eglCreateWindowSurface(s_display, config, reinterpret_cast<EGLNativeWindowType>(win), nullptr);
    if (!s_surface)
    {
...
IMGUI_IMPL_API bool ImGui_ImplSwitch_Init()
{
    ...
    if (!initEgl(nwindowGetDefault())) return false;
